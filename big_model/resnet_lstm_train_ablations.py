...
def build_train_lstm(args):
    ...
    if args.dataset_type == 'rgb':
        ...
        dataset_folder = 'Data_Segmented_Tracked_Action_JPG'
    ...
    from maaf.big_model.dataset_ablations import VideoDataset,MaskDataset,Co_trackerDataset,Co_trackerDataset_overlay
    ...
    if args.dataset_type == 'rgb':
        ...
        # Calcualted these values once and recorded
        mean = [0.33416336, 0.38611587, 0.33542804]
        std = [0.25486448, 0.2793474,  0.21826084]
        ...
        train_ds = Co_trackerDataset_overlay(ids=train_ids, labels=train_labels, labels_dict= labels_dict , transform=train_transformer)
    ...
    if args.dataset_type == 'rgb':
        ...
        test_ds = Co_trackerDataset_overlay(ids=test_ids, labels=test_labels, labels_dict= labels_dict, transform=test_transformer)
    ...
    class Resnt18LSTM(nn.Module):
        def __init__(self, params_model):
            super(Resnt18LSTM, self).__init__()
            ...
            # if args.dataset_type == 'mask' or args.dataset_type == 'co_tracker':
            #     baseModel.conv1 = torch.nn.Conv2d(1, 64, kernel_size=7, stride=2, padding=3, bias=False)
    ...
    model = Resnt18LSTM(params_model)
