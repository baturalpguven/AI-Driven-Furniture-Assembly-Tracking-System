...
def build_train_lstm(args):
    ...
    class ResntLSTM(nn.Module):
        def __init__(self, params_model):
            ...
            # baseModel = models.resnet152(pretrained=pretrained)
    ...
    lr = args.lr
    opt = optim.Adam(model.parameters(), lr=lr, weight_decay=args.weight_decay)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr', type=float, default=0.25e-4)
